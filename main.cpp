...
// Copyright (c) 2013 The ReFcoCoin developers
...
uint256 hashGenesisBlock("0x00000de7e0248ea84cc84f7e12b442cbc011c9116caa59e32d5d8c26494202eb");
static const unsigned int timeGenesisBlock = 1474532022;
...
const string strMessageMagic = "ReFcoCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60 * 24 * 15; // readjust difficulty once per hour
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "ReFcoCoin create";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x33af535aad89a9d6132ccef3110b7084c0436a5804285575288cb523ff417250"));
...
unsigned char pchMessageStart[4] = { 0xf7, 0xd2, 0xa1, 0xfc };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ReFcoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ReFcoCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ReFcoCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ReFcoCoin-miner");
    ...
    try { loop {
        ...
        printf("Running ReFcoCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("ReFcoCoinMiner terminated\n");
        throw;
    }
}
